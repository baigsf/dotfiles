...
local function setup()
  ...
  set_highlight("NvimTreeFolderIcon", { fg = colors.bright_yellow })
  set_highlight("NvimTreeFolderName", { fg = colors.fg })
  set_highlight("NvimTreeOpenedFolderName", { fg = colors.fg, italic = true })
  set_highlight("NvimTreeFileIcon", { fg = colors.white })
  set_highlight("NvimTreeFileName", { fg = colors.fg })
  set_highlight("NvimTreeGitDirty", { fg = colors.bright_yellow })
  set_highlight("NvimTreeGitStaged", { fg = colors.bright_green })
  set_highlight("NvimTreeGitNew", { fg = colors.bright_green })
