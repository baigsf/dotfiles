...
local function setup()
  ...
  set_highlight("FloatBorder", { fg = colors.surface2, bg = "NONE" })
  set_highlight("FloatTitle", { fg = colors.magenta, bg = "NONE" })
  ...
  set_highlight("MoreMsg", { fg = colors.cyan })
  set_highlight("Question", { fg = colors.cyan })

  set_highlight("Pmenu", { fg = colors.fg, bg = colors.surface0 })
  set_highlight("PmenuSel", { fg = colors.bg, bg = colors.surface2 })
  ...
  set_highlight("SpellCap", { undercurl = true, sp = colors.cyan })
  ...
  set_highlight("Include", { fg = colors.yellow })
  set_highlight("Define", { fg = colors.yellow })
  set_highlight("Macro", { fg = colors.yellow })
  set_highlight("PreCondit", { fg = colors.yellow })
  ...
  set_highlight("Tag", { fg = colors.green })
  ...
  set_highlight("@constant.macro", { fg = colors.yellow })
  ...
  set_highlight("@attribute", { fg = colors.yellow })
  set_highlight("@property", { fg = colors.fg })
  set_highlight("@function", { fg = colors.green })
  set_highlight("@function.builtin", { fg = colors.green })
  set_highlight("@function.call", { fg = colors.green })
  set_highlight("@function.macro", { fg = colors.yellow })
  set_highlight("@function.method", { fg = colors.green })
  set_highlight("@function.method.call", { fg = colors.green })
  ...
  set_highlight("@keyword.import", { fg = colors.yellow })
  ...
  set_highlight("DiagnosticInfo", { fg = colors.cyan })
  ...
  set_highlight("DiagnosticUnderlineInfo", { undercurl = true, sp = colors.cyan })
  ...
  set_highlight("TelescopeBorder", { fg = colors.magenta, bg = "NONE" })
  set_highlight("TelescopePromptNormal", { fg = colors.fg, bg = "NONE" })
  set_highlight("TelescopePromptBorder", { fg = colors.magenta, bg = "NONE" })
  set_highlight("TelescopePromptTitle", { fg = colors.magenta, bg = "NONE" })
  set_highlight("TelescopePreviewTitle", { fg = colors.magenta, bg = "NONE" })
  set_highlight("TelescopeResultsTitle", { fg = colors.magenta, bg = "NONE" })
  set_highlight("TelescopeSelection", { fg = colors.bg, bg = colors.surface2 })
  ...
  set_highlight("WhichKeyBorder", { fg = colors.magenta, bg = "NONE" })

  set_highlight("NeoTreeNormal", { fg = colors.fg, bg = "NONE" })
  set_highlight("NeoTreeNormalNC", { fg = colors.surface2, bg = "NONE" })
  set_highlight("NeoTreeFloatBorder", { fg = colors.magenta, bg = "NONE" })
  set_highlight("NeoTreeDirectoryIcon", { fg = colors.magenta })
  ...
  set_highlight("NvimTreeRootFolder", { fg = colors.magenta, bold = true })

  set_highlight("CmpItemAbbr", { fg = colors.fg })
  set_highlight("CmpItemAbbrMatch", { fg = colors.green, bold = true })
  set_highlight("CmpItemAbbrMatchFuzzy", { fg = colors.green, bold = true })
