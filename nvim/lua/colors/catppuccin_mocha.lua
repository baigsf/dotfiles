...
local function setup()
  ...
  set_highlight("NvimTreeNormalNC", { fg = colors.overlay0, bg = colors.bg })
  set_highlight("NvimTreeEndOfBuffer", { fg = colors.overlay0 })
  set_highlight("NvimTreeWinSeparator", { fg = colors.surface1, bg = colors.bg })
  set_highlight("NvimTreeFolderIcon", { fg = colors.blue, bold = true })
  set_highlight("NvimTreeFolderName", { fg = colors.fg })
  set_highlight("NvimTreeOpenedFolderName", { fg = colors.lavender })
  set_highlight("NvimTreeEmptyFolderName", { fg = colors.overlay0 })
  ...
  set_highlight("NvimTreeGitMerge", { fg = colors.mauve })
  set_highlight("NvimTreeGitRenamed", { fg = colors.teal })
  set_highlight("NvimTreeGitStaged", { fg = colors.green })
  set_highlight("NvimTreeGitUntracked", { fg = colors.overlay0 })
  set_highlight("NvimTreeIndentMarker", { fg = colors.overlay0 })
  set_highlight("NvimTreeCursorLine", { bg = colors.surface0 })
  set_highlight("NvimTreeLineNr", { fg = colors.overlay0 })
  set_highlight("NvimTreeRootFolder", { fg = colors.lavender, bold = true })
  set_highlight("NvimTreeSpecialIcon", { fg = colors.mauve })
