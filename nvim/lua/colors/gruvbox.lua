...
local function setup()
  ...
  set_highlight("NvimTreeWinSeparator", { fg = colors.dark_gray, bg = colors.bg })
  set_highlight("NvimTreeFolderIcon", { fg = colors.bright_yellow, bold = true })
  set_highlight("NvimTreeFolderName", { fg = colors.fg })
  set_highlight("NvimTreeOpenedFolderName", { fg = colors.bright_orange })
  ...
  set_highlight("NvimTreeModifiedFile", { fg = colors.bright_yellow, bold = true })
  set_highlight("NvimTreeGitDeleted", { fg = colors.bright_red })
  set_highlight("NvimTreeGitMerge", { fg = colors.bright_magenta })
  set_highlight("NvimTreeGitRenamed", { fg = colors.bright_cyan })
  set_highlight("NvimTreeGitStaged", { fg = colors.bright_green })
  set_highlight("NvimTreeGitUntracked", { fg = colors.gray })
  set_highlight("NvimTreeIndentMarker", { fg = colors.gray })
  set_highlight("NvimTreeCursorLine", { bg = colors.dark_gray })
  set_highlight("NvimTreeLineNr", { fg = colors.gray })
  set_highlight("NvimTreeRootFolder", { fg = colors.bright_yellow, bold = true })
  set_highlight("NvimTreeSpecialIcon", { fg = colors.bright_orange })
